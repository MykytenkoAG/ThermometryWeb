          ...
          <div class="g-1" style="width:3%">
            <div class="col">
              ...
              <ul class="nav me-auto mt-2" style="margin-left: 5px;">
                <li>
                    <a href="#" id="instr-href-text" class="nav-link text-black" data-bs-toggle="tooltip" data-bs-placement="right" title="Просмотр активных сигналов АПС">
                ...
                <li>
                    <a href="#" id="instr-href-video" class="nav-link text-black" data-bs-toggle="tooltip" data-bs-placement="right" title="Просмотр активных сигналов АПС">
                ...
                <li>
                    <a href="https://marine-electric.com/" target=”_blank” id="instr-href-company-site" class="nav-link text-black" data-bs-toggle="tooltip" data-bs-placement="right" title="Просмотр активных сигналов АПС">
                ...
                <li>
                    <a href="https://www.linkedin.com/company/neptunelectro/mycompany/" target=”_blank” id="instr-href-linkedin" class="nav-link text-black" data-bs-toggle="tooltip" data-bs-placement="right" title="Просмотр активных сигналов АПС">
